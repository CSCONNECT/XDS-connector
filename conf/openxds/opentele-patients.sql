...
('2512484916^^^&1.2.208.176.1.2&ISO', '', '2512484916^^^&1.2.208.176.1.2&ISO', 'urn:oasis:names:tc:ebxml-regrep:ObjectType:RegistryObject:Person', 'urn:oasis:names:tc:ebxml-regrep:StatusType:Submitted', '1.0', 'Danish Test', 'Nancy Ann', '', 'Berggren'),
('2512688916^^^&1.2.208.176.1.2&ISO', '', '2512688916^^^&1.2.208.176.1.2&ISO', 'urn:oasis:names:tc:ebxml-regrep:ObjectType:RegistryObject:Person', 'urn:oasis:names:tc:ebxml-regrep:StatusType:Submitted', '1.0', 'OpenTele Test', 'Lene', '', 'Jensen'),
('1103811376^^^&1.2.208.176.1.2&ISO', '', '1103811376^^^&1.2.208.176.1.2&ISO', 'urn:oasis:names:tc:ebxml-regrep:ObjectType:RegistryObject:Person', 'urn:oasis:names:tc:ebxml-regrep:StatusType:Submitted', '1.0', 'OpenTele Test', 'Kiran', '', 'Liaqat'),
('1212852635^^^&1.2.208.176.1.2&ISO', '', '1212852635^^^&1.2.208.176.1.2&ISO', 'urn:oasis:names:tc:ebxml-regrep:ObjectType:RegistryObject:Person', 'urn:oasis:names:tc:ebxml-regrep:StatusType:Submitted', '1.0', 'OpenTele Test', 'Svend', '', 'Andersson'),
('1105491135^^^&1.2.208.176.1.2&ISO', '', '1105491135^^^&1.2.208.176.1.2&ISO', 'urn:oasis:names:tc:ebxml-regrep:ObjectType:RegistryObject:Person', 'urn:oasis:names:tc:ebxml-regrep:StatusType:Submitted', '1.0', 'OpenTele Test', 'Carl', '', 'Petersen'),
('1206322639^^^&1.2.208.176.1.2&ISO', '', '1206322639^^^&1.2.208.176.1.2&ISO', 'urn:oasis:names:tc:ebxml-regrep:ObjectType:RegistryObject:Person', 'urn:oasis:names:tc:ebxml-regrep:StatusType:Submitted', '1.0', 'OpenTele Test', 'John', '', 'Hansen');
