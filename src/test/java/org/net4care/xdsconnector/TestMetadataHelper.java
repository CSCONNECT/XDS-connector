...
public class TestMetadataHelper {
  ...
  private final String className = "ExampleDocument";
  ...
  public void createClinicalDocumentClassCode() {
    ClassificationType clstype = helper.createClinicalDocumentClassCode(className);
    String control = "<Classification\n" +
        ...
        "    <ValueList>\n" +
        "      <Value>2.16.840.1.113883.4208.100.9</Value>\n" +
        "    </ValueList>\n" +
        "  </Slot>\n" +
        "  <Name>\n" +
  ...
  public void createConfidentialityCode() {
    ClassificationType clstype = helper.createConfidentialityCode(className, "N");
    String control = "<Classification\n" +
  ...
  public void createEventCodeList() {
    ClassificationType clstype = helper.createEventCodeList(className, "2.16.840.1.113883.3.4208.100.5", "ZZ3160", "Blodtryksmåling");
    String control = "<Classification\n" +
  ...
  public void createFormatCode() {
    ClassificationType clstype = helper.createFormatCode(className);
    String control = "<Classification\n" +
        ...
        "  <Slot name=\"codingScheme\">\n" +
        "    <ValueList> \n" +
        "      <Value>urn:ad:dk:medcom:phmr:full</Value>\n" +
        "    </ValueList>\n" +
        "  </Slot>\n" +
        "  <Name>\n" +
  ...
  public void createHealthcareFacilityTypeCode() {
    ClassificationType clstype = helper.createHealthcareFacilityTypeCode(className, "22232009", "2.16.840.1.1133883.3.4208.100.11", "hospital");
    String control = "<Classification\n" +
  ...
  public void createTypeCode() {
    ClassificationType clstype = helper.createTypeCode(className, "2.16.840.1.113883.6.1", "53576-5", "Personal Health Monitoring Report");
    String control = "<Classification\n" +
  ...
  public void createUniqueId() {
    ExternalIdentifierType extid = helper.createUniqueId(className, "2.16.840.1.113883.3.4208", "aa2386d0-79ea-11e3-981f-0800200c9a66");
